...
Note: I found the version of my r program I submitted for the previous homework gave very noisy data with a lot of variation in the sequences.  I altered the program slightly and gave single nucleotide polymorphisms a higher probability relative to the other mutations (I believe this is more accurate to the real world), in order to decrease the noise in the data.
...
Identical results.
This were the only tests I had time to compile, since I misremembered when the project was due; apologies for the lack of more interesting data (I had 45 minutes to generate it).  Still, it seems plain to me that the 0.75 value is the more correct from these tests.
